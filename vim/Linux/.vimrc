"Settings organized after the vim commad 'options'.
"--------------------------------------------------------------------------
...
set scrolloff=5 
set ch=2                         "number of lines used for the command-line
...
if &backupdir =~# '^\.,'
    let &backupdir = "/Users/andrew/Library/Vim/backup," . &backupdir
endif
" the swap file
" -------------------------------------------------------------------------
set swapfile
if &directory =~# '^\.,'
    let &directory = "/Users/andrew/Library/Vim/swap," . &directory
endif
...
set undofile
if &undodir =~# '^\.\%(,\|$\)'
    let &undodir = "/Users/andrew/Library/Vim/undo," . &undodir
endif
" executing external commands ---------------------------------------------
" running make and jumping to errors --------------------------------------
" language specific -------------------------------------------------------
" various -----------------------------------------------------------------
" perform global substitution, eg. :%s/pattern/replacement-----------------
set gdefault 
...
" TODO: search the right place for these settings
" window layout when using windows inside vim
set winwidth=84
set winheight=5
set winminheight=5
set winheight=999
...
" TODO: rethink if these mappings are needed
